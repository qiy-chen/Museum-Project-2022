...
public class Customer extends UserRole
{
  ...
  public Ticket addTicket(Museum aMuseum)
  {
    return new Ticket(aMuseum, this);
  }
  ...
  /* Code from template association_AddManyToOne */
  public Loan addLoan(Museum aMuseum, Artifact aArtifact)
  {
    return new Loan(aMuseum, this, aArtifact);
  }
