...
public abstract class RoomRole
{
  ...
  public RoomRole(UUID aRoomRoleId)
  {
    roomRoleId = aRoomRoleId;
  ...
  public boolean setRoomRoleId(UUID aRoomRoleId)
  {
  ...
  public String toString()
  {
    return super.toString() + "["+ "]" + System.getProperties().getProperty("line.separator") +
            "  " + "roomRoleId" + "=" + (getRoomRoleId() != null ? !getRoomRoleId().equals(this)  ? getRoomRoleId().toString().replaceAll("  ","    ") : "this" : "null");
  }
}